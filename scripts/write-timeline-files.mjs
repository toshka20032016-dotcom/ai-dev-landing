...
fs.writeFileSync(path.join("src", "app", "wiki", "[slug]", "WikiPageClient.tsx"), wikiClient, "utf8");
fs.writeFileSync(path.join("src", "components", "wiki", "LiveProjectRoadmap.tsx"), roadmap, "utf8");
