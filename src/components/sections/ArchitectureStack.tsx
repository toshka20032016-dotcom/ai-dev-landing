...
export default function ArchitectureStack() {
  ...
  return (
    <section className="relative z-10 mx-auto max-w-6xl overflow-hidden px-4 py-24">
      ...
      <div className="relative transform-gpu rounded-[24px] border border-white/5 bg-slate-950/20 p-6 shadow-[0_4px_30px_rgba(0,0,0,0.4)] backdrop-blur-md will-change-transform md:p-10">
        <div className="mb-12 flex flex-col justify-between gap-6 border-b border-white/5 pb-8 lg:flex-row lg:items-center">
          ...
          <div className="flex gap-1 self-start rounded-[24px] border border-white/5 bg-black/40 p-1 lg:self-center">
              ...
              >
                {activeTab === tab.key && (
                  <motion.div
                    ...
                    className="absolute inset-0 rounded-[24px] border border-white/5 bg-white/10 shadow-inner"
