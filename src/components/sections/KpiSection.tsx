          ...
          {kpi.items.map((stat, idx) => {
            ...
            return (
              <motion.div
                ...
                className={`group relative overflow-hidden rounded-2xl border border-white/5 bg-slate-950/40 p-6 shadow-2xl backdrop-blur-lg transition-all duration-300 hover:border-white/15 hover:shadow-[0_0_40px_rgba(6,182,212,0.12)] ${GPU_LAYER} glass-card`}
              >
