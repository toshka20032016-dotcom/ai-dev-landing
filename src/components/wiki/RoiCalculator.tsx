      ...
      <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
        <div className="space-y-4">
          <div className="space-y-2">
            <div className="flex justify-between font-mono text-xs"><span className="text-gray-400">{roi.hoursLabel}</span><span className="font-bold text-white">{hoursSpent} {roi.hoursUnit}</span></div>
